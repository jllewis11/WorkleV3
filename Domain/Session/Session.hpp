...
namespace Domain::Session
{
  ...
  struct ApplicantSession      : SessionBase{ ApplicantSession     ( const UserCredentials & credentials ); };
  struct CompanySession     : SessionBase{ CompanySession    ( const UserCredentials & credentials ); };
